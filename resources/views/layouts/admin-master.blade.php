...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
          href="{{ URL::asset('assets/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}">
    <!-- Daterange picker -->
    <link rel="stylesheet"
          href="{{ URL::asset('assets/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
    ...
    <!--[if lt IE 9]>
    <script src="{{ URL::asset('assets/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js')}}"></script>
    <script src="{{ URL::asset('assets/https://oss.maxcdn.com/respond/1.4.2/respond.min.js')}}"></script>
    <![endif]-->
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>Nieruchomości</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="admin/estate"><i class="fa fa-circle-o"></i>Wszystkie</a></li>
                        <li><a href="admin/estate/create"><i class="fa fa-circle-o"></i>Dodaj nową</a></li>
                    </ul>
                </li>
                {{--<li class="treeview">--}}
                    {{--<a href="#">--}}
